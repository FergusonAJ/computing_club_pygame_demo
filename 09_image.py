...
circle_vel_x = random.uniform(-30, 30)
circle_vel_y = random.uniform(-30, 30)
...
while is_game_running: 
  ...
  screen.blit(marmot_img, (circle_x - marmot_img.get_width() // 2, circle_y - marmot_img.get_height() // 2))
  pygame.display.flip()
